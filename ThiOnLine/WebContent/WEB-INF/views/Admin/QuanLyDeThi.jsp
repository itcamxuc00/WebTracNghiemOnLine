                        ...
                        <div class="panel panel-border-top">
                            <div class="col-12">
                                <button data-target="#add-elment" data-toggle="modal" class="btn btn-dark btn-labeled"><b><i
                                            class="fas fa-plus-square"></i></b>Thêm đề thi</button>
                            </div>
                        </div>
                                	  ...
                                	  <tr>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li class="dropdown-item"><a href="XoaDeThi?maDe=${deThi.maDeThi}"></a>   Xóa</li>
                                                    <li class="dropdown-item">Sửa</li>
                                                    <li class="dropdown-item">Đã giao</li>
                                                    <li data-id="${deThi.maDeThi }" data-target="#fac" data-toggle="modal" class="dropdown-item zao">Giao
                                                        đề thi</li>                                                   
                                                </ul>
                                            </div>
                                        </td>
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-panel has-padding active">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="tieu-de" type="text"
                                                                        class="form-control" />
                                                                </div>
                                                                <div class="d-inline-block" style="width: 45%">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Lớp học</label>
                                                                        <select id="lop" name="lopHoc" class="custom-select">
																			
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Thời lượng</label>
                                                                        <input id="thoi-luong" value="15" type="text" class="form-control" />
                                                                    </div>
                                                                </div>
                                                                <div class="d-inline-block" style="width: 45%">
                                                                    <div class="form-group">
                                                                        <label class="control-label">Bắt đầu</label>
                                                                        <input id="bat-dau" type="datetime-local" class="form-control" />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">Kết thúc</label>
                                                                        <input id="ket-thuc" type="datetime-local" class="form-control" />
                                                                    </div>
                                                                  	<div class="form-group">
                                                                   		<label class="control-label">Số lần làm bài</label>
                                                                    	<input id="so-lan" type="text" class="form-control" />
                                                                	</div>
                                                                </div>
                                                            </div>
                                                        </div>
